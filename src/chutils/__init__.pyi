...
class StoreManager:
    def __init__(self, backend: BaseStoreBackend | None = None, serializer: str | Any = "json", prefix: str = "") -> None: ...
    @classmethod
...
def store_cache(store: StoreManager | None = None, ttl: int | float = 60, key_prefix: str = "cache:") -> Callable[..., Any]: ...
