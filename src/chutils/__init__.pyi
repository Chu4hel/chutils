...
class AntidetectConfig:
    ...
    @classmethod
    def from_seed(cls, seed: int | str, os_target: str = "windows") -> AntidetectConfig: ...
    @classmethod
    def from_fingerprint(cls, profile: FingerprintProfile) -> AntidetectConfig: ...
    @classmethod
    def from_browserforge(cls, browser: str = "chrome", os_target: str = "windows") -> AntidetectConfig: ...
    @classmethod
    def from_procedural(cls, seed: int | str | None = None, os_target: str = "windows") -> AntidetectConfig: ...
