...
| `scraping`   | `playwright >=1.49`, `selenium >=4.27`                                                 | `chutils.scraping.humanize` — имитация поведения человека (мышь, клавиатура, паузы), анти-детекция (`apply_antidetect_playwright`, `apply_antidetect_selenium`, `extract_clearance_cookies`)                                                                                                  | `OptionalDependencyError` при вызове                                                                                                  |
