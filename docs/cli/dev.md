...
Запускает отслеживание изменений файлов проекта в режиме реального времени (Live Dev) и автоматически перезапускает внешний дочерний процесс или выбранную Python-функцию.
