...
def test_encrypt_portable_raises_dependency_error(
    mock_missing_cryptography: None,
) -> None:
...
def test_decrypt_portable_raises_dependency_error(
    mock_missing_cryptography: None,
) -> None:
...
def test_encrypt_file_raises_dependency_error(
    mock_missing_cryptography: None, tmp_path: Path
) -> None:
...
def test_decrypt_file_raises_dependency_error(
    mock_missing_cryptography: None, tmp_path: Path
) -> None:
