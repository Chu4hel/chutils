...
def test_antidetect_deterministic_canvas_seed():
...
def test_antidetect_cross_realm_iframe_protection():
...
def test_get_client_hints_chrome_windows():
...
def test_get_client_hints_macos_safari():
...
@pytest.mark.asyncio
async def test_launch_camoufox_missing_dependency():
...
@pytest.mark.asyncio
async def test_launch_camoufox_mocked_success():
